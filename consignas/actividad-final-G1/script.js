...
// ============================================================
// TABLA DE CONTENIDOS (ToC) DINÁMICA
// ============================================================
...
(function generarToC() {
  ...
  // En móvil, envolver en <details> para comportamiento de acordeón
...
(function inicializarProgreso() {
  ...
  const CLAVE_STORAGE = 'progreso-consigna-sueldos';
  ...
  function actualizarProgreso() {
    ...
    outputProgreso.textContent =
      completados + ' de ' + total + ' ítems completados (' + porcentaje + '%)';
  }
