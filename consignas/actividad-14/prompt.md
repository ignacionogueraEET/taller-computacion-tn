...
# Consigna
Realiza un modelo de factura como el de la imagen (luego la agregaré), puedes cambiar fuentes y colores siempre que cumplan las normas de contraste y accesibilidad.
Observaciones:
- La fecha debe actualizarse de acuerdo a la hora del sistema.
- Digitar número de cajas, descripción y precio de caja.
- Calcular valor: Número de cajas multiplicado por el precio de caja.
- IVA es igual al valor multiplicado por el % establecido.
- Total es igual a la suma de IVA y valor.
- Calcular el subtotal.
- Descuento es igual al subtotal multiplicado por el porcentaje establecido.
- Calcular el neto a pagar.
- Aplicar formato de moneda a las celdas que corresponda.
- Las fórmulas utilizadas deben poder ser copiadas.
